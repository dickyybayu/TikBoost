    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => const AIContentGeneratorScreen(
          ...
          description: 'Buat copywriting yang menarik berdasarkan 3 produk terlaris Anda menggunakan AI.',
        ),
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              if (featureName.contains('Key Metrics')) ...[
                const Text('📊 Key Metrics Analysis:', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                const Text('• Engagement Rate: 15.2% (+3% dari minggu lalu)'),
                ...
                const Text('🕐 Optimal Live Session Times:', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                ...
                const Text('📺 Live Stream Performance:', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                const Text('• Current Viewers: 1,250 (+15% dari rata-rata)'),
                ...
                const Text('📦 Recommended Product Bundles:', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
          ...
          child: Column(
            ...
            children: [
              if (featureName.contains('Live Session')) ...[
                const Text('🕐 Basic Live Session Tips (Free):', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                ...
                const Text('📦 Basic Bundle Ideas (Free):', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
            ...
            children: [
              Container(
                ...
                child: Icon(
                  icon,
                  size: 40,
                  color: isPremium ? Colors.brown.shade400 : Colors.grey.shade400,
                ),
              ),
              if (!isPremium)
                Positioned(
